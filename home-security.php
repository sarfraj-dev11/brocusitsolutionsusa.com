...
<section class="page-hero" style="background:
    linear-gradient(160deg, rgba(30,10,80,.82) 0%, rgba(10,5,32,.75) 40%, rgba(5,5,8,.88) 100%),
  ...
  <div style="max-width:1200px;margin:0 auto;padding:0 1.5rem;">
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:5rem;align-items:center;">
      <div>
        ...
        <p class="sec-p">Most security websites are owned by the company trying to sell you a system, so their advice always points back to their own product. Our recommendations are not tied to a single brand.</p>
        <p class="sec-p" style="margin-bottom:2.5rem">That means we can tell you when a basic setup is enough, when professional monitoring is worth it, and when you may not need a new system at all. You get one point of contact, a clear explanation of the choices in front of you, and a recommendation matched to your home rather than to a sales target.</p>
...
<!-- HONEST STATS -->
<section style="padding:7rem 0;background:#FFFFFF;position:relative;overflow:hidden;border-top:1px solid #EDE9FE;">
  <!-- Soft purple orb top-right -->
  <div style="position:absolute;top:-160px;right:-160px;width:560px;height:560px;border-radius:50%;background:radial-gradient(circle,rgba(124,58,237,.07) 0%,transparent 70%);pointer-events:none;"></div>
  <div style="position:absolute;bottom:-100px;left:-100px;width:400px;height:400px;border-radius:50%;background:radial-gradient(circle,rgba(124,58,237,.05) 0%,transparent 70%);pointer-events:none;"></div>

  <div style="max-width:1200px;margin:0 auto;padding:0 1.5rem;position:relative;z-index:1;">

    <!-- Header -->
    <div style="text-align:center;margin-bottom:5rem;">
      <span style="display:inline-flex;align-items:center;gap:.5rem;padding:.35rem 1rem;border-radius:999px;font-size:.72rem;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:#6D28D9;background:rgba(109,40,217,.07);border:1px solid rgba(109,40,217,.18);">
        <span style="width:5px;height:5px;border-radius:50%;background:#7C3AED;display:inline-block;"></span>
        Honest numbers, not scare tactics
      </span>
      <h2 class="sec-h-dark" style="margin:.875rem auto 1rem;text-align:center;">A clear look at home security<br>in the US today</h2>
      <p class="sec-sub-dark" style="max-width:580px;margin:0 auto;">We believe good decisions start with honest numbers, not scare tactics.</p>
    </div>
    ...
    <!-- Prose block — dark purple premium card -->
    <div style="background:linear-gradient(135deg,#1E0A52 0%,#2D1270 50%,#1A0A40 100%);border-radius:24px;padding:3rem;border:1px solid rgba(167,139,250,.2);box-shadow:0 20px 60px rgba(109,40,217,.15);position:relative;overflow:hidden;">
      <div style="position:absolute;top:-60px;right:-60px;width:300px;height:300px;border-radius:50%;background:radial-gradient(circle,rgba(167,139,250,.2),transparent 70%);pointer-events:none;"></div>
      <div style="position:relative;z-index:1;max-width:860px;margin:0 auto;">
        <div style="display:flex;align-items:center;gap:.75rem;margin-bottom:1.75rem;">
          <div style="width:36px;height:36px;border-radius:10px;background:rgba(167,139,250,.15);color:#C4B5FD;display:flex;align-items:center;justify-content:center;font-size:.85rem;flex-shrink:0;"><i class="fas fa-file-lines"></i></div>
          <span style="font-size:.75rem;font-weight:700;letter-spacing:.1em;text-transform:uppercase;color:#A78BFA;">What the data actually shows</span>
        </div>
        <p style="font-size:1rem;color:rgba(255,255,255,.75);line-height:1.9;margin:0 0 1.25rem;">Burglary in the United States has actually been falling for more than two decades. According to the FBI's Uniform Crime Reporting data, the national burglary rate dropped to roughly 229 incidents per 100,000 residents in 2024, one of the lowest levels on record. So no, there is not a break-in "every few seconds" the way some ads claim.</p>
        <p style="font-size:1rem;color:rgba(255,255,255,.75);line-height:1.9;margin:0 0 1.25rem;">What is still true is that hundreds of thousands of US homes are entered every year, and the financial hit is real. The FBI has estimated the average loss per burglary at more than 2,600 dollars, before you count the stress and the sense of safety that is hard to put a price on. The same data shows most break-ins happen through a door or a window, often one that was simply left unsecured.</p>
        <p style="font-size:1rem;color:rgba(255,255,255,.75);line-height:1.9;margin:0;">The encouraging part is that visible security genuinely works as a deterrent. In a University of North Carolina at Charlotte study of 422 incarcerated burglars, about 83 percent said they would try to find out whether a home had an alarm before attempting a break-in, and roughly 60 percent said they would move on to a different target if they found one. A well-chosen system does not just record a crime. It helps stop one from happening.</p>
      </div>
    </div>
    <p style="font-size:.72rem;color:#94A3B8;margin-top:1.25rem;text-align:center;">Sources: FBI Crime Data Explorer; University of North Carolina at Charlotte</p>
...
<section style="padding:7rem 0;background:linear-gradient(180deg,#F8FAFC 0%,#FFFFFF 100%);position:relative;overflow:hidden;border-top:1px solid #E2E8F0;">
  ...
  <div style="max-width:1200px;margin:0 auto;padding:0 1.5rem;display:grid;grid-template-columns:1fr 1fr;gap:5rem;align-items:start;position:relative;z-index:1;">
    ...
    <div>
      <div style="background:#FFFBEB;border:1px solid #FDE68A;border-radius:20px;padding:2rem;margin-bottom:1.5rem">
        <div style="display:flex;align-items:center;gap:.75rem;margin-bottom:1rem">
          <div style="width:36px;height:36px;border-radius:10px;background:#FEF3C7;color:#D97706;display:flex;align-items:center;justify-content:center;font-size:.9rem"><i class="fas fa-triangle-exclamation"></i></div>
      ...
      <div style="background:#F0FDF4;border:1px solid #BBF7D0;border-radius:16px;padding:1.5rem">
        <p style="font-size:.875rem;color:#166534;line-height:1.7;margin:0"><em>"Honest guidance like this is exactly why people call us instead of a salesperson."</em></p>
      </div>
    </div>
  </div>
</section>
...
<!-- ═══ FINAL CTA ═══ -->
<?php
$cta_headline = 'Ready for straight answers about <br><span style="background:linear-gradient(135deg,#A78BFA,#60A5FA);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;">protecting your home?</span>';
