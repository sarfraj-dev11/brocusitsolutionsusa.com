...
define('NAV_ITEMS', serialize([
    ...
    ['href' => 'home-security',  'slug' => 'home-security', 'label' => 'Home Security', 'dropdown' => [
        'products' => [
            ['href' => 'home-security/smart-indoor-camera', 'slug' => 'smart-indoor-camera', 'label' => 'Smart Indoor Camera', 'desc' => 'High-res indoor monitoring'],
            ['href' => 'home-security/smart-outdoor-camera', 'slug' => 'smart-outdoor-camera', 'label' => 'Smart Outdoor Camera', 'desc' => 'Weatherproof exterior security'],
            ['href' => 'home-security/smart-doorbell-camera', 'slug' => 'smart-doorbell-camera', 'label' => 'Smart Doorbell Camera', 'desc' => 'See who is at your front door'],
            ['href' => 'home-security/smart-door-locks', 'slug' => 'smart-door-locks', 'label' => 'Smart Door Locks', 'desc' => 'Keyless entry and remote access'],
            ['href' => 'home-security/door-and-window-sensors', 'slug' => 'door-and-window-sensors', 'label' => 'Door & Window Sensors', 'desc' => 'Perimeter breach detection'],
            ['href' => 'home-security/smart-alarm-system', 'slug' => 'smart-alarm-system', 'label' => 'Smart Alarm System', 'desc' => 'Comprehensive home protection'],
            ['href' => 'home-security/smart-security-panel', 'slug' => 'smart-security-panel', 'label' => 'Security Control Panel', 'desc' => 'The central hub for your system'],
        ],
        'services' => [
