...
<header id="site-header">
  ...
  <div class="sh-mobile-call-strip">
    <a href="tel:<?= PHONE_TEL ?>">
      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.13.87.35 1.71.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
    ...
    <nav class="sh-nav" aria-label="Primary">
      ...
      <div class="sh-dropdown-wrap">
        <a href="<?= url($item['href']) ?>"
          ...
          <svg class="sh-chevron" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="6 9 12 15 18 9"/></svg>
            ...
            <div class="sh-mega-inner">
              ...
              <div class="sh-mega-col">
                <div class="sh-mega-col-header">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><rect x="2" y="3" width="7" height="7" rx="1"/><rect x="15" y="3" width="7" height="7" rx="1"/><rect x="2" y="14" width="7" height="7" rx="1"/><rect x="15" y="14" width="7" height="7" rx="1"/></svg>
                  Products
                </div>
                ...
                <a href="<?= url($child['href']) ?>" class="sh-mega-link" role="menuitem">
                  <div class="sh-mega-link-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><rect x="2" y="3" width="7" height="7" rx="1"/><rect x="15" y="3" width="7" height="7" rx="1"/><rect x="2" y="14" width="7" height="7" rx="1"/><rect x="15" y="14" width="7" height="7" rx="1"/></svg></div>
              ...
              <div class="sh-mega-col">
                ...
                <a href="<?= url($child['href']) ?>" class="sh-mega-link <?= $_cur===$child['slug']?'sh-mega-link--active':'' ?>" role="menuitem">
                  <div class="sh-mega-link-icon"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
                  <div class="sh-mega-link-body">
                    <div class="sh-mega-link-title"><?= htmlspecialchars($child['label']) ?></div>
                    <div class="sh-mega-link-desc"><?= htmlspecialchars($child['desc']) ?></div>
                  </div>
  ...
  <div class="sh-mobile-menu" id="sh-mobile-menu" role="dialog" aria-modal="true" aria-label="Navigation menu">
    ...
    <nav class="sh-drawer-nav" aria-label="Mobile Primary">
      ...
      <div class="sh-drawer-accordion" style="--i:<?= $idx ?>">
        <button class="sh-drawer-link sh-drawer-parent" aria-expanded="false">
          ...
          <svg class="sh-acc-chevron" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
      ...
      <a href="<?= url($item['href']) ?>"
         ...
         <?= $_cur === $item['slug'] ? 'aria-current="page"' : '' ?>>
        <span><?= htmlspecialchars($item['label']) ?></span>
        <svg class="sh-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
      </a>
      <?php endif; ?>
      <?php endforeach; ?>
    </nav>
    ...
    <div class="sh-drawer-footer">
      <a href="tel:<?= PHONE_TEL ?>" class="sh-drawer-cta">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 2h3a2 2 0 0 1 2 1.72c.13.87.35 1.71.7 2.81a2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
        <div>
...
<style>
/* ── FONTS ── */
#site-header, #site-header *{font-family:'Space Grotesk',system-ui,sans-serif}
...
/* ── LOGO SWAP ── */
.logo-transparent{display:block;height:56px;width:auto;object-fit:contain;transition:opacity .3s}
.logo-scrolled{display:none;height:56px;width:auto;object-fit:contain}
...
/* ── LOGO ── */
.sh-logo{display:flex;align-items:center;text-decoration:none;flex-shrink:0;transition:opacity .2s,transform .25s cubic-bezier(.34,1.56,.64,1)}
.sh-logo:hover{opacity:.9;transform:scale(1.04)}

/* ── DESKTOP NAV ── */
.sh-nav{display:flex;align-items:center;justify-content:center;gap:6px;overflow:visible;position:relative;}
...
.sh-link--active{color:#fff;font-weight:600;}
...
.sh-link-underline{
  ...
  width:0;transition:width .28s cubic-bezier(.4,0,.2,1);
}
.sh-link--active .sh-link-underline{width:calc(100% - 20px)}
.sh-link:hover .sh-link-underline{width:calc(100% - 20px)}

/* ── DROPDOWN WRAP ── */
.sh-dropdown-wrap{position:relative;display:inline-flex}
.sh-has-dropdown{display:inline-flex;align-items:center;gap:5px;cursor:pointer}
.sh-chevron{transition:transform .25s cubic-bezier(.4,0,.2,1);flex-shrink:0;opacity:.7}
/* ── DROPDOWN WRAP ── */
.sh-dropdown-wrap{position:relative;display:inline-flex;align-items:center}
...
.sh-dropdown-wrap.open .sh-chevron{transform:rotate(180deg);opacity:1}

/* ── MEGA DROPDOWN PANEL ── */
.sh-mega{
  position:absolute;
  top:calc(100% + 4px); /* sits directly under the nav link with a tiny gap */
...
/* Divider */
.sh-mega-divider{background:#F1F5F9;margin:24px 0}
...
.sh-mega-link-icon svg{opacity:1;width:18px;height:18px;}
.sh-mega-link-body{display:flex;flex-direction:column;gap:3px}
.sh-mega-link-title{font-size:14.5px;font-weight:700;color:#0F172A}
.sh-mega-link-desc{font-size:12px;color:#64748B;line-height:1.45}
...
.sh-mega-coming svg{color:#94A3B8}
...
.sh-drawer-parent{
  ...
  transition:all .22s;font-family:'Space Grotesk',system-ui,sans-serif;
}
.sh-drawer-parent:hover{color:#fff;background:rgba(255,255,255,0.07);border-color:rgba(255,255,255,0.1)}
.sh-drawer-parent[aria-expanded="true"]{color:#fff;background:rgba(255,255,255,0.07);border-color:rgba(255,255,255,0.1)}
.sh-acc-chevron{transition:transform .28s cubic-bezier(.4,0,.2,1);flex-shrink:0;opacity:.5}
.sh-drawer-parent[aria-expanded="true"] .sh-acc-chevron{transform:rotate(180deg);opacity:1}

.sh-drawer-sub{padding:4px 8px 8px 12px;border-left:1px solid rgba(255,255,255,0.08);margin:4px 0 4px 16px}
.sh-drawer-sub-label{font-size:10px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:rgba(167,139,250,0.55);padding:8px 8px 4px}
.sh-drawer-sub-link{display:block;padding:9px 10px;border-radius:8px;font-size:14.5px;font-weight:500;color:rgba(255,255,255,0.7);text-decoration:none;transition:all .18s}
.sh-drawer-sub-link:hover{color:#fff;background:rgba(255,255,255,0.06)}
.sh-drawer-sub-link--active{color:#fff;font-weight:600}
.sh-drawer-sub-coming{font-size:12px;color:rgba(255,255,255,0.3);padding:8px 10px;font-style:italic}
.sh-drawer-sub-all{display:block;margin-top:8px;padding:8px 10px;font-size:13px;font-weight:600;color:rgba(167,139,250,0.7);text-decoration:none;border-top:1px solid rgba(255,255,255,0.06);transition:color .18s}
.sh-drawer-sub-all:hover{color:#A78BFA}
...
@keyframes ctaPulse{
  ...
  50%{box-shadow:0 4px 28px rgba(124,58,237,0.7),0 0 0 4px rgba(124,58,237,0.12)}
}
.sh-cta-pill:hover{transform:translateY(-2px);box-shadow:0 10px 32px rgba(124,58,237,0.6)!important;filter:brightness(1.1);animation:none}
.sh-cta-pill:active{transform:translateY(0)}
#site-header.scrolled .sh-cta-pill{background:#fff;color:#6D28D9;box-shadow:0 4px 16px rgba(0,0,0,0.15);animation:none}
#site-header.scrolled .sh-cta-pill:hover{box-shadow:0 8px 24px rgba(0,0,0,0.2)!important;filter:brightness(1.04)}
...
.sh-burger:hover{background:rgba(139,92,246,0.2);border-color:rgba(139,92,246,0.6)}
#site-header.scrolled .sh-burger{background:rgba(255,255,255,0.1);border-color:rgba(255,255,255,0.25)}
#site-header.scrolled .sh-burger:hover{background:rgba(255,255,255,0.18)}
...
#site-header.scrolled .burger-bar{background:#fff}

/* X animation when open */
.sh-burger.open .bar1{transform:translateY(7px) rotate(45deg)}
.sh-burger.open .bar2{opacity:0;transform:scaleX(0)}
.sh-burger.open .bar3{transform:translateY(-7px) rotate(-45deg)}
...
.sh-mobile-call-strip a strong{font-weight:700;letter-spacing:0.03em}
...
.sh-drawer-header img{height:40px;width:auto;object-fit:contain}
...
.sh-drawer-close:hover{background:rgba(239,68,68,0.15);border-color:rgba(239,68,68,0.3);color:#f87171}
...
/* Drawer Nav Links */
.sh-drawer-nav{display:flex;flex-direction:column;padding:4px 16px;flex:1;gap:4px}
...
.sh-arrow{color:rgba(255,255,255,0.25);flex-shrink:0;transition:transform .2s,color .2s}
.sh-drawer-link:hover .sh-arrow{transform:translateX(4px);color:rgba(255,255,255,0.7)}
.sh-drawer-link.sh-link--active .sh-arrow{color:rgba(255,255,255,0.6)}
...
.sh-drawer-footer{
  ...
  flex-shrink:0;
  opacity:0;animation:drawerLinkIn .4s cubic-bezier(.16,1,.3,1) .5s forwards;
}
.sh-drawer-cta{
...
.sh-drawer-cta:hover{transform:translateY(-2px);box-shadow:0 12px 40px rgba(124,58,237,0.45);filter:brightness(1.06)}
.sh-drawer-cta:active{transform:translateY(0)}
.sh-drawer-cta svg{flex-shrink:0;opacity:0.9}
.sh-drawer-cta-label{font-size:12px;font-weight:500;opacity:.75;letter-spacing:0.03em;text-transform:uppercase;margin-bottom:2px}
.sh-drawer-cta-number{font-size:17px;font-weight:700;letter-spacing:0.02em}
...
@media(max-width:960px){
  ...
  .logo-transparent,.logo-scrolled{height:48px !important}
}
@media(max-width:600px){
  .nav-inner{height:56px !important;padding:0 16px !important}
  .logo-transparent,.logo-scrolled{height:44px !important}
  .sh-mobile-menu{width:100vw;border-left:none}
}
@media(max-width:380px){
  .nav-inner{padding:0 12px !important}
  .logo-transparent,.logo-scrolled{height:40px !important}
  .sh-drawer-link{font-size:15px;padding:12px 14px}
}

/* Tablet tweak: show small pill */
@media(min-width:700px) and (max-width:960px){
  .sh-cta-pill{display:inline-flex !important;font-size:13px;padding:8px 14px}
}
</style>
...
(function(){
  ...
  window.addEventListener('scroll', function(){ closeAllDropdowns(null); }, {passive:true});
