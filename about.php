...
<section style="padding:7rem 0;background:linear-gradient(180deg,#F8FAFC 0%,#F1F5F9 100%);">
  <div style="max-width:1200px;margin:0 auto;padding:0 1.5rem;position:relative;z-index:1;">
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:3rem;position:relative;">
      ...
      <?php foreach (
        [
          ['n' => '01', 'i' => 'fa-comments', 'bg' => 'linear-gradient(135deg,#7C3AED,#4F46E5)', 't' => 'You reach out', 'd' => 'A quick call or message starts the conversation. No forms longer than you need.'],
          ['n' => '02', 'i' => 'fa-house-chimney', 'bg' => 'linear-gradient(135deg,#6D28D9,#4338CA)', 't' => 'We learn about your home', 'd' => 'We ask about your space, your concerns, and your budget — with genuine curiosity, not a script.'],
          ['n' => '03', 'i' => 'fa-lightbulb', 'bg' => 'linear-gradient(135deg,#5B21B6,#3730A3)', 't' => 'We explain your options', 'd' => 'Clearly, in plain language, with the pros and cons of each path. No jargon.'],
          ...
          ['n' => '05', 'i' => 'fa-user-check', 'bg' => 'linear-gradient(135deg,#6D28D9,#4338CA)', 't' => 'You stay in control', 'd' => 'If the answer is to wait, we respect that too. You decide what happens next, always.'],
        ] as $s
      ): ?>
      ...
      <div style="position:relative;z-index:2;max-width:700px;margin:0 auto;">
        ...
        <<<<<<< HEAD
          ...
          <div style="margin-top:3.5rem;display:flex;justify-content:center;align-items:center;gap:1.5rem;flex-wrap:wrap;">
            ...
            <span style="width:4px;height:4px;border-radius:50%;background:rgba(255,255,255,.2);"></span>
            <span style="display:inline-flex;align-items:center;gap:.6rem;font-size:.95rem;color:rgba(255,255,255,.6);font-family:var(--font-p, 'Manrope', sans-serif);"><i class="fas fa-check" style="color:#059669;font-size:.8rem;"></i> Real, Human Advisors</span>
          </div>
      </div>
    </div>
  </div>
